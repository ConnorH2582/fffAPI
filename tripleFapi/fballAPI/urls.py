...
urlpatterns = patterns('',
    ...
    #winning teams
    url(r'^(?P<year>20[0-2][0-9])/(?P<week>week-{1}[1]*[0]*[0-7]{1})/winners/$', WeeklyWinnersView.as_view()),

    #losing teams
    url(r'^(?P<year>20[0-2][0-9])/(?P<week>week-{1}[1]*[0]*[0-7]{1})/losers/$', WeeklyLosersView.as_view()),
)
